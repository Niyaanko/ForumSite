<main>
    <h2 class="main_title">通報コメント無視</h2>
<?php 
...
?>
    ...
    <h3 class="question_msg" >このコメントの通報を無視し、通報一覧から削除しますか？</h3>
    <?= form_open("report/ignore/".$report_comment['comment_id']);?>
        <input type="hidden" name="ignore_flg" value="TRUE">
